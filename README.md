...
**Last updated:** 2026-09-04 22:00 UTC — **1,872 indicators** · TLP:CLEAR
...
|---|---:|---|
| IOCs — last 24 hours | 1,873 | [`objects`](https://raw.githubusercontent.com/r4y79/ti-feed/main/taxii2/api/collections/ffbda76d-19e2-5545-a2cc-bbb5d6ee0f14/objects/index.json) |
...
`daily/YYYY/MM/` keeps every past run — a dated report and the matching CSV. Newest: [`daily/2026/09/report_20260904.md`](daily/2026/09/report_20260904.md).
