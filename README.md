...
**Last updated:** 2026-09-11 22:00 UTC — **2,140 indicators** · TLP:CLEAR
...
|---|---:|---|
| IOCs — last 24 hours | 2,141 | [`objects`](https://raw.githubusercontent.com/r4y79/ti-feed/main/taxii2/api/collections/ffbda76d-19e2-5545-a2cc-bbb5d6ee0f14/objects/index.json) |
...
| CVE (30days) | 26 | [`objects`](https://raw.githubusercontent.com/r4y79/ti-feed/main/taxii2/api/collections/c6715fd0-21b8-50c5-85bd-bfba36bce52f/objects/index.json) |
...
`daily/YYYY/MM/` keeps every past run — a dated report and the matching CSV. Newest: [`daily/2026/09/report_20260911.md`](daily/2026/09/report_20260911.md).
